  ...
  methods:{
    ...
    addEmployee(){
        let Admin_id = User.id();
         var data = {name:this.form.name, email:this.form.email, address:this.form.address , cnic:this.form.cnic, salary:this.form.salary, jd:this.form.jd, phone:this.form.phone, photo:this.form.photo, Admin_id:Admin_id}
